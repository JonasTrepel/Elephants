...
## GIS07 Server: "C:\\Users\\au713983\\.conda\\envs\\rgee_env
...
#ee$Initialize(project='ee-jonastrepel')  # <-- jonas.trepel at bio
ee$Initialize(project='jonas-trepel')  # <-- jonas.trepel at gmail
