...
NB! Both the 1000m_models stript as well as the step_selection_analysis script exceed the processing capacity of personal computers (at least of mine) and may have to be run on a supercomputer, server or cloud  
